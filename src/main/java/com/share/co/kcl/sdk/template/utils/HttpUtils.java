...
import com.share.co.kcl.sdk.template.exception.HttpException;
import okhttp3.*;
...
public class HttpUtils {
    ...
    public static String doGet(String path, Map<String, String> headers, Map<String, String> params) {
        ...
        if (MapUtils.isNotEmpty(params)) {
            params.forEach(httpBuilder::addEncodedQueryParameter);
        }
    ...
    public static String constructURI(String endpoint, String action, Map<String, String> params) {
        HttpUrl.Builder builder = Objects.requireNonNull(HttpUrl.parse(endpoint)).newBuilder();
